...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/fhir.ph.ereferral|current/StructureDefinition/ereferral-service-request)
...
```json
{
  ...
  "url" : "urn://example.com/ph-ereferral/fhir/StructureDefinition/ereferral-service-request",
  "version" : "0.1.0",
  ...
  "differential" : {
    "element" : [{
      ...
      "constraint" : [{
        ...
        "source" : "urn://example.com/ph-ereferral/fhir/StructureDefinition/ereferral-service-request"
      }]
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "urn://example.com/ph-ereferral/fhir/ValueSet/ereferral-service-category"
      }
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "urn://example.com/ph-ereferral/fhir/ValueSet/ereferral-priority"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "example",
        "valueSet" : "urn://example.com/ph-ereferral/fhir/ValueSet/ereferral-reason"
      }
    },
    {
