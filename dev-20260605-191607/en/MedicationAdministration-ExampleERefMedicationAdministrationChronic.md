...
**context**: [Encounter: identifier = urn://example.com/ph-ereferral/encounter-id#ENC-2025-001234; status = finished; class = ambulatory (ActCode#AMB); type = Consultation; priority = Emergency; period = 2025-03-16 08:00:00+0800 --> 2025-03-16 10:30:00+0800; reasonCode = Chest pain](Encounter-ExampleERefEncounter.md)
...
```json
{
  ...
  "meta" : {
    "profile" : ["urn://example.com/ph-ereferral/fhir/StructureDefinition/ereferral-medication-administration"]
  },
  "status" : "completed",
  "medicationReference" : {
