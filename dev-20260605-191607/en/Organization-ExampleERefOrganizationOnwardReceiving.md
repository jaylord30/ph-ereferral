# Example Onward Receiving Facility (for Task) - PH eReferral Implementation Guide v0.1.0

## Example Organization: Example Onward Receiving Facility (for Task)

Profile: [PH Core Organization](https://build.fhir.org/ig/jldalisay95/ph-core-jld/StructureDefinition-ph-core-organization.html)
