# Example eReferral Patient - PH eReferral Implementation Guide v0.1.0

## Example Patient: Example eReferral Patient

Profile: [PH Core Patient](https://build.fhir.org/ig/jldalisay95/ph-core-jld/StructureDefinition-ph-core-patient.html)
